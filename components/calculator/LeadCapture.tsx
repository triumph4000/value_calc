  ...
  if (submitted) {
    return (
      <div className="border border-gray-200 bg-gray-50 rounded-2xl p-8 text-center animate-fade-in">
        ...
        <h3 className="text-xl font-black text-[#32373c] mb-2 tracking-tight">You&apos;re all set.</h3>
    ...
    <div className="border border-gray-200 bg-gray-50 rounded-2xl p-6 sm:p-8">
      <div className="max-w-xl mx-auto">
        <div className="mb-6 text-center">
          <p className="text-xs font-black text-[#17C662] uppercase tracking-widest mb-3">Unlock Your Full Report</p>
          <h3 className="text-2xl font-black text-[#32373c] mb-3 tracking-tight">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="block text-xs font-bold text-gray-400 mb-1.5">First Name <span className="text-gray-300 font-medium">(optional)</span></label>
              <input type="text" value={firstName} onChange={(e) => setFirstName(e.target.value)} placeholder="Alex"
                className="w-full bg-white border border-gray-200 rounded-xl py-3 px-4 text-[#32373c] placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-[#32373c] focus:border-transparent transition-colors font-medium" />
            </div>
            <div>
              <label className="block text-xs font-bold text-gray-400 mb-1.5">Company <span className="text-gray-300 font-medium">(optional)</span></label>
          ...
          <div>
            <label className="block text-xs font-bold text-gray-400 mb-1.5">Business Email <span className="text-red-400">*</span></label>
          ...
          <button type="submit" disabled={loading}
            className="w-full bg-[#32373c] hover:bg-black disabled:opacity-60 disabled:cursor-not-allowed text-white font-black py-3.5 px-6 rounded-full transition-colors duration-200 text-base tracking-wide">
