...
export default function LeadCapture({ inputs, results, onCaptured }: LeadCaptureProps) {
  ...
  if (submitted) {
    return (
      <div className="border border-[#17C662]/25 bg-[#17C662]/5 rounded-2xl p-8 text-center animate-fade-in">
        ...
        <h3 className="text-xl font-black text-white mb-2 tracking-tight">You&apos;re all set.</h3>
        <p className="text-[#6B7280] text-sm font-medium max-w-sm mx-auto">
  ...
  return (
    <div className="border border-[#17C662]/25 bg-[#17C662]/5 rounded-2xl p-6 sm:p-8">
      <div className="max-w-xl mx-auto">
        <div className="mb-6 text-center">
          <p className="text-xs font-black text-[#17C662] uppercase tracking-widest mb-3">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="block text-xs font-bold text-[#6B7280] mb-1.5">
                First Name <span className="text-[#3A3A3A] font-medium">(optional)</span>
              </label>
              <input
                type="text"
                value={firstName}
                ...
                placeholder="Alex"
                className="w-full bg-[#0D0D0D] border border-[#2A2A2A] rounded-xl py-3 px-4 text-white placeholder-[#3A3A3A] focus:outline-none focus:ring-2 focus:ring-[#17C662] focus:border-transparent transition-colors font-medium"
              />
            </div>
            <div>
              <label className="block text-xs font-bold text-[#6B7280] mb-1.5">
                Company <span className="text-[#3A3A3A] font-medium">(optional)</span>
              </label>
              <input
                type="text"
                value={company}
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-[#17C662] hover:bg-[#12A352] disabled:opacity-60 disabled:cursor-not-allowed text-[#0D0D0D] font-black py-3.5 px-6 rounded-full transition-colors duration-200 text-base tracking-wide"
          >
